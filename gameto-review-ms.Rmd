...
In some pteridophytes (most lycophytes; Ophioglossaceae; Schizaeaceae; *Stromatopteris*), the gametophytes are subterranean and achlorophyllous, making them even more cryptic and less likely to be noticed.
...
Bioinformatic methods used for identification have included BLAST [@Altschul1997] [e.g., @Nitta2017], which provides metrics indicating the probability that the two sequences are identical by chance, and phylogenetic inference [e.g., @DeGroot2011a].
...
Finally, an algorithm is used to sort results into successful identifications or failures based on a percent-identity cutoff. 
...
Gametophyte image by Jon Houseman used under CC BY-SA 4.0 license (https://creativecommons.org/licenses/by-sa/4.0/), downloaded from https://commons.wikimedia.org/wiki/File:Pter1025_Fern_gametophytes.jpg.
Sporophyte silhouette (A) by Olegivvit used under CC BY-SA 3.0 license (https://creativecommons.org/licenses/by-sa/3.0/), downloaded from http://phylopic.org. 
