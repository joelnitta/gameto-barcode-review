...
Few studies have analyzed the barcode gap for ferns, but those that have often find at least some overlap between intraspecific and interspecific genetic distances [@Nitta2008; @Wang2016; @Liu2018; @Trujillo-Argueta2021; but see @DeGroot2011a].
This indicates that DNA barcoding is unlikely to be 100% successful in all cases; therefore, it is important to quantify the expected failure rate and/or expected undistinguishable taxa for each study.
