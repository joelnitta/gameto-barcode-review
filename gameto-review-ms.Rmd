...
<!-- FIXME: add wordcount after rendering -->
Number of words:
...
Prior to attempting DNA-based identification of unknown gametophytes, the barcode library should evaluated to ensure that the selected markers are sufficiently divergent between species to allow discrimination.
...
The careful studies of @Kuo2017b and @Park2021, which included observations of gametangia, have helped to provide insights into the mechanisms suppressing functional sporophyte production in these populations.
Furthermore, although @Kuo2017b could not confidently identify the obligate independent gametophyte population in Taiwan to species due to a lack of sufficiently similar reference sequences, @Chen2019b later sequenced additional sporophytes and confirmed the identity of the gametophytes as *Haplopteris capillaris* (Copel.) C. W. Chen, S. Linds. & K. T. Yong.
This highlights the importance of the reference library in conducting DNA barcoding of fern gametophytes.
